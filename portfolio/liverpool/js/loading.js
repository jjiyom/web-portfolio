var max_delay_time = 2000,
    ...
    progress_bar_container_bg_color = "var(--color-k)",
    ...
    progress_bar_color = "var(--color-point-01)",
    ...
    progress_font_color = "var(--color-point-01)",
    ...
    setTimeout(function(){
        progress_update = setInterval(function(){
            if(is_stop){
                ...
                counter($(".progress_text"), $(".progress_text").text().replace(/%/g,""), 100);//이걸언제제거함대체
                setTimeout(function(){
